...
| Status freshness | ✅ current as of 2026-09-26 07:37:15 UTC |
| Last checked | 2026-09-26 07:37:15 UTC |
| Runner/job started | 2026-09-26 05:28:08 UTC |
| Keepalive started | 2026-09-26 05:28:40 UTC |
| Runner age | 129 min |
| Runner lifecycle remaining | 200 min |
| Auto restart threshold | 20 min remaining |
| Nominal handoff | 2026-09-26 10:58:08 UTC |
| Hard job timeout | 2026-09-26 11:18:08 UTC |
| Planned timeout headroom | 20 min |
| Successor already queued | — |
| RDC verification success | 100% (9 samples) |
| Keepalive completion | 75% (4 samples) |
| Handoff ≤15 min | 100% (8 samples) |
| Median handoff gap | 0.7 min |
| Run details | [Open current run](https://github.com/aminsh35322088-ctrl/GitHub-Runner-Lab/actions/runs/36220866971) |
...
Tailscale uses the repository secrets `TS_OAUTH_CLIENT_ID` and `TS_OAUTH_SECRET`. Use a dedicated Tailscale OAuth client for this Runner with `auth_keys: write` and only `tag:ssh`. The Runner workflow never advertises exit-node routes; it joins the Tailnet as `GitHub-Lab` and enables Tailscale SSH explicitly after connection.
