...
| Last checked | 2026-09-18 19:04:22 UTC |
| Runner/job started | 2026-09-18 17:12:14 UTC |
| Keepalive started | 2026-09-18 17:12:56 UTC |
| Runner age | 112 min |
| Runner lifecycle remaining | 217 min |
| Auto restart threshold | 20 min remaining |
| Nominal handoff | 2026-09-18 22:42:14 UTC |
| Hard job timeout | 2026-09-18 23:02:14 UTC |
| Planned timeout headroom | 20 min |
| Successor already queued | — |
| RDC verification success | 71% (7 samples) |
| Keepalive completion | 33% (6 samples) |
| Handoff ≤15 min | 83% (12 samples) |
| Median handoff gap | 0.0 min |
| Run details | [Open current run](https://github.com/aminsh35322088-ctrl/GitHub-Runner-Lab/actions/runs/35372878959) |
