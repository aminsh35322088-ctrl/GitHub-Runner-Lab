...
- 19 regression tests passed at the time of this review. The suite has since grown substantially and is exercised through the direct Runner validation contract in `AGENTS.md`.
